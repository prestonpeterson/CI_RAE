...
class CIRAEHelp:
    ...
    def ci_rae_help(self):
        ...
        answer = ("Thanks for using CI_RAE, "+ user_name + "! Follwing the format \"ci_rae <command>\", here is a list of commands that you can use:\n\n"
        ...
        "**best_worst**: shows you your best and worst comments and submission")
